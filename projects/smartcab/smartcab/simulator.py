    ...
    def __init__(self, env, size=None, update_delay=2.0, display=True, log_metrics=False, optimized=False):
        ...
        if self.log_metrics:
            ...
            if a.learning:
                ...
                self.table_file = open(self.table_filename, 'w') ## USED TO BE 'wb' BUT DOESNT SEEM TO BE WRITING ANYTHING ON THE TXT
            else:
            ...
            self.log_file = open(self.log_filename, 'w')   ## USED TO BE 'wb' BUT CAUSES ERROR: bytes-like object required, not str
